...
export function StoryContent({ horse }: { horse: Horse }) {
  ...
  if (!horse.story_text) {
    return (
      <div className="animate-in fade-in duration-1000 flex min-h-[80vh] flex-col items-center justify-center px-6 text-center">
  ...
  return (
    <article className="animate-in fade-in duration-1000 px-3 py-6">
      {/* Back link */}
      <Link
        href={`/horses/${horse.id}`}
